...
ImageButton1.Image = "rbxassetid://17298754409"
...
function Update:Window(text,logo,keybind)
	...
	Logo.Image = "rbxassetid://17298754409"
    ...
    function uitab:AddTab(text,img)
        ...
        IDK.Image = "rbxassetid://17298754409" .. tostring(img)
        ...
        game:GetService("RunService").Stepped:Connect(function()
            pcall(function()
                ...
                ScrollTab.CanvasSize = UDim2.new(0,0,0,PLL.AbsoluteContentSize.Y + 30)
            end)
        end)
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://17298754409"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://17298754409"
    ...
    function main:AddDropdown(text,option,callback)
        ...
        DropImage.Image = "rbxassetid://17298754409"
...
local Library = Update:Window("Waifu HUB v1","",Enum.KeyCode.RightControl);
...
H:AddLabel("Code By Truong")

H:AddLabel("Anbatocom")
H:AddLabel("Batokum")
H:AddLabel("Discord: Ko_co")
 

H:AddButton("Waifu Hub",function()
setclipboard("Penda Gaming")
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://17298754409";
      Title = "Waifu Hub", 
      Text = "Copied";
})
end)
...
SoundSFX.SoundId = "rbxassetid://17298754409"
SoundSFX:Play()
...
Misc:AddButton("Kaitun Cap", function(value)
		...
		for k,v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..v,true) == 1 then 
				...
				huhu.Image = "rbxassetid://17298754409"
